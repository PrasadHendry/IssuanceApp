...
namespace IssuanceApp.Data
{
    ...
    public class AuditTrailEntry
    {
        ...
        // --- RENAMED FROM GmOperations... ---
        public string HodAction { get; set; }
        public string AuthorizedBy { get; set; }
        public DateTime? HodAt { get; set; }
    ...
    public class HodQueueItemDto // RENAMED FROM GmQueueItemDto
    {
        public string RequestNo { get; set; }
        public DateTime RequestDate { get; set; }
        public string Product { get; set; }
    ...
    public class QaQueueItemDto
    {
        ...
        public DateTime HodAt { get; set; }
        public string HodComment { get; set; }
        public string HodAction { get; set; } // Needed for worker to derive status if needed
        // --- END RENAMED ---
        public string FromDepartment { get; set; }
        public string BatchNo { get; set; }
        public string ItemMfgDate { get; set; }
